...
<main class="flex-1 overflow-y-auto bg-slate-50 p-4 md:p-6">
    <div class="mb-8 bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        <h3 class="text-2xl md:text-3xl font-extrabold text-slate-800 tracking-tight">Wali Kelas</h3>
        <p class="text-slate-500 text-sm mt-1 font-medium">Pemetaan dan penugasan wali kelas per rombongan belajar.</p>
    </div>
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-12 flex flex-col items-center justify-center text-center min-h-[350px]">
        <div class="w-20 h-20 bg-indigo-50 text-indigo-400 rounded-full flex items-center justify-center text-3xl mb-4">
            <i class="fa-solid fa-user-check"></i>
        </div>
        <h4 class="text-lg font-extrabold text-slate-700">Modul Dalam Pengembangan</h4>
        <p class="text-slate-400 mt-2 max-w-md text-sm">Modul plotting dan riwayat wali kelas per semester sedang dalam perancangan.</p>
